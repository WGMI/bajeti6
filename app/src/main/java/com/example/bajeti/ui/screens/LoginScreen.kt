...
fun LoginScreen(viewModel: AuthViewModel) {
    ...
    LaunchedEffect(email, password) {
        if (loginState.error != null) viewModel.clearError()
    }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                Text("Please enter your details to sign in.", fontSize = 13.sp, color = TextSecondary)
            }
            ...
            Column(modifier = Modifier.fillMaxWidth()) {
                Row(
                    ...
                    TextButton(onClick = {}, contentPadding = PaddingValues(0.dp)) {
                        Text("Forgot?", fontSize = 12.sp, color = TealPrimary)
                    }
                }
                OutlinedTextField(
                    value = password,
            ...
            OutlinedButton(
                ...
                Text("Sign in with Google", color = TextPrimary, fontSize = 15.sp)
            }
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                TextButton(onClick = {}, contentPadding = PaddingValues(0.dp)) {
                    Text("Create an account.", fontSize = 13.sp, color = TealPrimary)
                }
            }
        }
